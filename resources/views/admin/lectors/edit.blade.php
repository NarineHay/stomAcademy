...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            <form action="{{ route('lectors.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $user->lector->specialization }}" name="specialization" class="form-control" placeholder="Введите специализация...">
                    </div>
