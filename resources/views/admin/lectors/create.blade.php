...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            <form action="{{ route('admin.lectors.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control select2" name="direction_id">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="direction_id" class="form-control"
