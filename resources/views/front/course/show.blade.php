                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-12">
                                <div class="section-menu d-block d-xl-none mt-4">
                                   <ul class="pb-3">
                                       <li><a href="#about-course-txt" class="fs-14 lh-17 color-23 f-500">О курсе</a></li>
                                       <li><a href="#course-program" class="fs-14 lh-17 color-23 f-500">Программа</a></li>
                                       <li><a href="#lectors" class="fs-14 lh-17 color-23 f-500">Преподаватели</a></li>
                                       <li><a href="#registration" class="fs-14 lh-17 color-23 f-500">Зарегистрироваться</a></li>
                                       <li><a href="#faq" class="fs-14 lh-17 color-23 f-500">FAQ</a></li>
                                       <li><a href="#other-courses" class="fs-14 lh-17 color-23 f-500">Другие курсы</a></li>
                                       <li><a href="#contacts" class="fs-14 lh-17 color-23 f-500">Контакты</a></li>
                                   </ul>
            ...
            <div id="lectors" class="main4">
                <div class="container">
                    ...
                    <div class="many-lector">
                        ...
                        <div
                            class="lector-cards d-flex flex-wrap flex-lg-nowrap justify-content-lg-between justify-content-center align-items-center">
                        ...
                        <div class="main8-2 contacts-main-div mt-lg-0 mt-4">
                                    ...
                                    <div class="icons pt-4 gap-2">
                                        ...
                                        <a href="https://www.viber.com/en/" class="viber me-2">
                                            <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M15.0156 11.1396C14.9312 10.5743 14.6967 10.1129 14.3071 9.76147L14.0132 10.022C14.1652 10.1569 14.2967 10.3153 14.3979 10.4901C14.5769 10.7988 14.654 11.1533 14.6546 11.5081C14.6547 11.5623 14.6573 11.6196 14.6747 11.6701C14.7334 11.8398 14.9884 11.8188 15.0329 11.6505C15.0452 11.6042 15.0466 11.555 15.0494 11.5341C15.0426 11.4192 15.0466 11.5551 15.0494 11.5341C15.0426 11.4192 15.0385 11.332 15.0319 11.2449C15.0293 11.2095 15.0209 11.1748 15.0156 11.1396Z" fill="white"/>
                                                <path d="M15.0494 11.5342C15.0467 11.555 15.0428 11.4192 15.0494 11.5342Z" fill="white"/>
                                                <path d="M14.0074 11.4936C14.0096 11.4934 14.0117 11.4923 14.0138 11.4921C14.0079 11.4921 13.9988 11.4922 13.9895 11.4926C13.9956 11.4927 14.0011 11.4936 14.0074 11.4936Z" fill="white"/>
                                                <path d="M14.0075 11.4936C14.0012 11.4937 13.9956 11.4927 13.9895 11.4926C13.9592 11.4934 13.9279 11.495 14.0075 11.4936Z" fill="white"/>
                                                <path d="M14.0138 11.4921C14.0116 11.4923 14.0095 11.4934 14.0074 11.4936C14.0239 11.4925 14.0224 11.4921 14.0138 11.4921Z" fill="white"/>
                                                <path d="M13.7116 10.2893L13.4124 10.5545C13.4289 10.5646 13.445 10.575 13.4607 10.5864C13.6051 10.6916 13.6964 10.8507 13.7385 11.0224C13.7599 11.1096 13.7678 11.2003 13.7779 11.29C13.7917 11.4127 13.8614 11.4881 13.9896 11.4925C13.9989 11.4923 14.0081 11.4921 14.0139 11.492C14.0756 11.4852 14.1375 11.4419 14.1573 11.3566C14.1692 11.305 14.1638 11.2479 14.159 11.1939C14.1218 10.7665 13.9602 10.4731 13.7116 10.2893Z" fill="white"/>
                                            </svg>
                                        </a>
                                        <a href="https://web.telegram.org/z/" class="telegram me-2">
                                            <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.5 25.1562C19.4036 25.1562 25 19.5598 25 12.6562C25 5.75269 19.4036 0.15625 12.5 0.15625C5.59644 0.15625 0 5.75269 0 12.6562C0 19.5598 5.59644 25.1562 12.5 25.1562Z" fill="#039BE5"/>
                                                <path d="M5.7197 12.3854L17.7718 7.73851C18.3312 7.53643 18.8197 7.87497 18.6384 8.72081L18.6395 8.71976L16.5874 18.3875C16.4353 19.0729 16.028 19.2396 15.4582 18.9166L12.3332 16.6135L10.8259 18.0656C10.6593 18.2323 10.5187 18.3729 10.1957 18.3729L10.4176 15.1927L16.2093 9.96039C16.4614 9.73851 16.153 9.61351 15.8207 9.83435L8.66345 14.3406L5.57803 13.3781C4.90824 13.1656 4.89366 12.7083 5.7197 12.3854Z" fill="white"/>
                                            </svg>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex flex-wrap ">
                                <div class="contact4 me-4 mb-3">
                                    <p class="fs-14 f-500 lh-17 color-47 mb-2">Литва</p>
                                    <a href="tel:+37052080969" class="color-23 f-600 fs-16 lh-20">+370 (5) 208-09-69</a>
                                </div>
                            ...
                            <h3 class="color-23 f-700 lh-40 mb-4">Наши социальные сети</h3>
