                        ...
                        <div class="d-flex flex-column flex-md-row mt-4">
                            <div class="d-flex">
                                <div class="bg-white br-12">
                                    <img src="{{\Illuminate\Support\Facades\Storage::url($blogs[0]->info->image)}}" alt="addPic" class="w-100">
                                    <div class="p-3">
                            ...
                            <div class="d-flex ms-0 ms-md-3 mt-2 mt-md-0">
                                <div class="bg-white br-12">
                                    <img src="{{\Illuminate\Support\Facades\Storage::url($blogs[1]->info->image)}}" alt="addPic" class="w-100">
                                    <div class="p-3">
                                        <p class="f-700 fs-16 m-0">
