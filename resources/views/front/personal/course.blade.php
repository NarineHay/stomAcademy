...
{{--        <div class="webinar_chat_messages  w-100" style=" height: 100vh">--}}
{{--            <div class="position-absolute bg-white w-100" style=" height: 100vh">--}}
{{--            </div>--}}
{{--            <div class="position-relative w-100 h-100">--}}
{{--                <livewire:front.personal-courses-chat />--}}
{{--            </div>--}}
{{--        </div>--}}

{{--    </div>--}}

<div class="position-relative pt-6 bg-white w-100" style="height: 400px;">
