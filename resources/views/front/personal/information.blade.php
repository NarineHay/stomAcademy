                        ...
                        <div class="mt-4">
                                ...
                                <div class="collapse show" id="profile-1">
                                    <div>
                                        <div class="mt-4">
                                            <div class="d-flex">
                                                <div>
                                                    <img src="{{\Illuminate\Support\Facades\Storage::url($user->userinfo->image)}}" alt="pic">
                                                </div>
                                            ...
                                            <div class="d-flex mt-4 flex-column flex-md-row">
                                                <div>
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <input type="text" class="br-12 inputStyle px-3 py-2 fs-14 f-600" id="fname" aria-describedby="nameHelp" value="{{$user->userinfo->fname}}">
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="d-flex flex-column ms-0 ms-md-3">
                                                        <label for="lname" class="mt-2 mb-1 f-500 fs-12">Фамилия</label>
                                                        <input type="text" class="br-12 inputStyle px-3 py-2 fs-14 f-600" id="lname" aria-describedby="lnameHelp" value="{{$user->userinfo->lname}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mt-3 bg-white br-12 p-4">
                                ...
                                <div class="collapse" id="profile-2">
                                    <div class="mt-3">
                                        <input type="number" class="br-12 inputStyle px-3 py-2 fs-14 f-600" id="phone" aria-describedby="numberHelp" value={{$user->userinfo->phone}}>
                                    </div>
                                    <div class="mt-4">
                                        <button class="btn btn-primary py-2 px-4 br-12">Сохранить</button>
                                    </div>
                            ...
                            <div class="mt-3 bg-white br-12 p-4">
                                ...
                                <div class="collapse" id="profile-3">
                                    <div class="mt-3">
                                        <input type="email" class="br-12 inputStyle px-3 py-2 fs-14 f-600" id="email" aria-describedby="emailHelp" value="{{$user->email}}">
                                    </div>
                                    <div class="mt-4">
                                        <button class="btn btn-primary py-2 px-4 br-12">Сохранить</button>
                                    </div>
                            ...
                            <div class="mt-3 bg-white br-12 p-4">
                                ...
                                <div class="collapse" id="profile-4">
                                    <div class="mt-3">
                                        <input type="password" class="br-12 inputStyle px-3 py-2 fs-14 f-600" id="password" aria-describedby="passwordHelp">
                                    </div>
                                    <div class="mt-4">
                                        <button class="btn btn-primary py-2 px-4 br-12">Сохранить</button>
                                    </div>
