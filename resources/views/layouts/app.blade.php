                ...
                <div class="mt-6 w-100">
                    <div class="d-flex mt-3 mt-lg-4">
                        <a href="{{ route('home') }}"><span
                                class="fs-12 f-500 text-white">{{ __('header.menu.home') }}</span></a>
        ...
        <div class="container">
            <div class="row footer-border-bottom">
                ...
                <div class="col-12 col-lg-4 mt-lg-6 mb-2 mb-md-4 fs-20 f-600 ft-menu-a-div">
                    <a href="/">
                        <p>{{ __('header.menu.home') }}</p>
                    </a>
                    <a href="{{ route('payment') }}">
                        <p>{{ __('header.menu.payment') }}</p>
                    </a>
                    <a href="{{ route('contacts') }}">
                        <p>{{ __('header.menu.contact') }}</p>
                    </a>
                    <a href="{{ route('contract_offer') }}">
                        <p>{{ __('header.menu.contract_offer') }}</p>
                    </a>
                    <a href="{{ route('conf') }}">
                        <p>{{ __('header.menu.conf') }}</p>
                    </a>
                </div>
                    ...
                    <div class="d-flex flex-wrap flex-md-nowrap">
                        ...
                        <div class="ms-md-6 text-white">
                            ...
                            <a href="tel:{{ __('courses.contacts.info.phone.le') }}">
                                <p class="fs-16 f-600">{{ __('courses.contacts.info.phone.le') }}</p>
                            </a>
                            <p class="opacity-50 mt-4 fs-14 f-500">{{ __('courses.contacts.info.country.be') }}</p>
                            <a href="tel:{{ __('courses.contacts.info.phone.be') }}">
                                <p class="fs-16 f-600">{{ __('courses.contacts.info.phone.be') }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" style="right: 20px;top: 20px;position: absolute" class="btn-close"
