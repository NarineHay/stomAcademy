    ...
    <div class="col-lg-10 col-12 mb-4 mb-lg-6">
        ...
        <div class="d-flex justify-content-between flex-column flex-lg-row mt-4 align-items-lg-center">
            <div class="d-flex education_tags mb-3 mb-lg-0">
                ...
                <a href="{{route('course.index')}}" class="px-2 px-md-3 py-2 fs-14 f-600 br-12 @if($type == "courses") active bg-white @else bg-light-gray @endif ms-2 text-black btn_text">
                    Онлайн-курсы
                </a>
                <a href="{{route('webinar.index')}}" class="fs-14 py-2 px-2 f-600 br-12 @if($type == "webinars") active bg-white @else bg-light-gray @endif text-black ms-2 btn_text">
                    Вебинары
                </a>
                <a href="{{route('conference')}}" class="px-2 px-md-3 py-2 fs-14 f-600 br-12 @if($type == "conferences") active bg-white @else bg-light-gray @endif text-black btn_text ms-2">
                    Онлайн-конференции
                </a>
            </div>
                    ...
                    <div class="bg-white br-12">
                        ...
                        <div class="p-3">
                            ...
                            <div
                                ...
                                <div class="mt-3 mt-xl-0 d-flex flex-row flex-xl-column">
                                    @if($course->sale)
                                        ...
                                        <span class="del f-700 text-secondary fs-16  text-nowrap">{{$course->price->html()}}</span>
                                    @else
                            ...
                            <form class="dublicat_form" method="POST" action="{{route('addToCart')}}">
                                ...
                                <button class="btn btn-outline-primary w-100 f-600 br-12 mt-3 py-2 fs-14">{{ __('index.buy_webinar') }}</button>
                            </form>
                        </div>
                    </div>
                </a>
