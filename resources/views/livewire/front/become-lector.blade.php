<div class="modal-content">
    <form wire:submit.prevent="submit" method="post">
        <div class="w-100">
            <img class="w-100" src="{{asset('dist/image/be-lecture.jpg')}}">
        </div>
        ...
        <div class="modal-footer">
            <button
                class="btn btn-primary w-100 f-600 fs-14 px-4 py-3 br-12 white-space send_mail">{{ __("modals.to_by_lector.button") }}</button>
        </div>
    </form>
</div>
