...
return [
    ...
    "start" => "Старт",
    "start_text" => "Доступно к просмотру после покупки",
    ...
    "by_lecture" => "Купить лекцию",
    "certificate" => "Сертификат",
    "unLim" => "Безлимитный просмотр",
    "infinity" => "Неограниченный просмотр",
    "by" => "Купить",
    "money_back" => "7-дневная гарантия замены или возврата денег",
    "lections" => "лекции",
    "menu" => [
        "about" => "О курсе",
...
Для Вашей безопасности, на сайте подключена система надёжного шифрования данных и ХМL протокол, который обеспечивает дополнительный уровень безопасности для онлайн-кредитных и дебетовых карт и все сведения о Вашем платеже и реквизитах передаются по надёжно защищённым каналам связи. Но, если Вы всё-таки, по каким-либо причинам, не можете оплатить через интернет, мы можем выставить счет для оплаты на юридическое лицо.',
    ...
    "contacts" => [
        ...
        "info" => [
            ...
            "soc_group" => [
                "fb" => '<a href="https://www.facebook.com/stomacademy/" class="facebook me-2" target="_blank">
                ...
                "inst" => '  <a href="https://www.instagram.com/stom.academy/" class="instagram me-2" target="_blank">
                ...
                "tg" => '<a href="https://t.me/stomacademy" class="telegram me-2" target="_blank">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                ...
                "vk" => ' <a href="https://vk.com/stomacademy" class="wk me-2" target="_blank">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                ...
                "yt" => '    <a href="https://www.youtube.com/c/STOMACADEMY" class="youtube me-2" target="_blank">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
            ...
            "soc_wp_vb_tg" => '<div class="col-lg-6 col-12">
