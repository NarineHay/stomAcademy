...
return [
    ...
    "cart" => [
        "page_title_left" => "В корзине",
        "page_title_right" => "курсов",
        "lection" => "лекция",
        "sale" => "Скидка",
        "price" => "Цена",
        "to_pay" => "К оплате",
    ...
    "info" => [
        ...
        "delete_account_text" => "Вы уверены, что хотите удалить свой аккаунт?",
    ],
    "profile" => [
        "page_title" => "Профиль",
        "main_info" => "Добавить основную информацию",
        "fio" => "ФИО (для сертификата)",
        "your_clinic" => 'Ваша клиника',
        "from_sale" => 'От продаж',
        "bday" => "Дата рождения",
        "save" => "Сохранить",
        "add_work_experience" => "Добавить рабочий стаж",
        "add_education" => "Добавить образование",
        "biography" => "Биография",
        "directions" => "Добавить интересы",
        'logout' => "Выйти",
