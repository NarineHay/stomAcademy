...
<?php endif; ?>
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('front.personal-courses', [])->html();
} elseif ($_instance->childHasBeenRendered('qERYGXj')) {
    $componentId = $_instance->getRenderedChildComponentId('qERYGXj');
    $componentTag = $_instance->getRenderedChildComponentTagName('qERYGXj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qERYGXj');
} else {
    $response = \Livewire\Livewire::mount('front.personal-courses', []);
    $html = $response->html();
    $_instance->logRenderedChild('qERYGXj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views\front\personal\courses.blade.php ENDPATH**/ ?>