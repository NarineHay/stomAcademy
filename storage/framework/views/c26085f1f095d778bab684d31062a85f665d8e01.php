            ...
            <form action="<?php echo e(route('admin.course.update',$course->id)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" multiple name="direction_ids[]">
                            <?php $__currentLoopData = $data['directions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($direction->id); ?>" <?php echo e($course->directions->contains($direction) ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" value="<?php echo e($course->start_date); ?>" name="start_date" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">ДАТА ОКОНЧАНИЯ КУРСА*</label>
                        <input type="datetime-local" value="<?php echo e($course->end_date); ?>" name="end_date" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">ВИДЕО ПРИГЛАШЕНИЕ/ТРЕЙЛЕРЫ</label>
                        <input type="text" value="<?php echo e($course->video); ?>" name="video" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control" name="price_id">
                            <?php $__currentLoopData = $data['prices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($price->id); ?>" <?php echo e($price->id == $course->price_id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control" name="price_2_id">
                            ...
                            <?php $__currentLoopData = $data['prices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($price->id); ?>" <?php echo e($price->id == $course->price_2_id ? 'selected' : ''); ?>>
                                    <?php echo e($price->name); ?> - $<?php echo e($price->usd); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" multiple="multiple" name="webinar[]">
                                <?php $__currentLoopData = $data['webinar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($webinar->status != 0): ?>
                                        <option value="<?php echo e($webinar->id); ?>" <?php if( $course->webinars->where("webinar_id",$webinar->id)->count()): ?> selected <?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($course->url_to_page); ?>" name="url_to_page" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">ИЗОБРАЖЕНИЕ</label>
                        <div class="form-group">
                            <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($course->image)); ?>" height="100" alt=""/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($course->bg_image)); ?>" height="100" alt=""/>
                        </div>
                        <div class="custom-file">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            <?php $__currentLoopData = $course->infos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group ml-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="gridCheck" name="online" <?php if($course->online==1): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views\admin\courses\edit.blade.php ENDPATH**/ ?>