...
} elseif ($_instance->childHasBeenRendered('BKnIHZB')) {
    $componentId = $_instance->getRenderedChildComponentId('BKnIHZB');
    $componentTag = $_instance->getRenderedChildComponentTagName('BKnIHZB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BKnIHZB');
} else {
    $response = \Livewire\Livewire::mount('front.home-login', []);
    $html = $response->html();
    $_instance->logRenderedChild('BKnIHZB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('front.home-login', [])->html();
} elseif ($_instance->childHasBeenRendered('Oh0gKOG')) {
    $componentId = $_instance->getRenderedChildComponentId('Oh0gKOG');
    $componentTag = $_instance->getRenderedChildComponentTagName('Oh0gKOG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Oh0gKOG');
} else {
    $response = \Livewire\Livewire::mount('front.home-login', []);
    $html = $response->html();
    $_instance->logRenderedChild('Oh0gKOG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                        </div>
...
} elseif ($_instance->childHasBeenRendered('sFDplzN')) {
    $componentId = $_instance->getRenderedChildComponentId('sFDplzN');
    $componentTag = $_instance->getRenderedChildComponentTagName('sFDplzN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sFDplzN');
} else {
    $response = \Livewire\Livewire::mount('front.become-lector', []);
    $html = $response->html();
    $_instance->logRenderedChild('sFDplzN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
} elseif ($_instance->childHasBeenRendered('t7DNenG')) {
    $componentId = $_instance->getRenderedChildComponentId('t7DNenG');
    $componentTag = $_instance->getRenderedChildComponentTagName('t7DNenG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('t7DNenG');
} else {
    $response = \Livewire\Livewire::mount('front.follow', []);
    $html = $response->html();
    $_instance->logRenderedChild('t7DNenG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
