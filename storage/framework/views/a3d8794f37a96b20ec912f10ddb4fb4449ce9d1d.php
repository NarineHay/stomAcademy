...
} elseif ($_instance->childHasBeenRendered('HLlkZJE')) {
    $componentId = $_instance->getRenderedChildComponentId('HLlkZJE');
    $componentTag = $_instance->getRenderedChildComponentTagName('HLlkZJE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HLlkZJE');
} else {
    $response = \Livewire\Livewire::mount('front.are-any-question-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('HLlkZJE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="contact1 me-4">
                                    ...
                                    <a href="tel:<?php echo e(__("courses.contacts.info.phone.ru")); ?>"
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="contact2 me-4">
                                    ...
                                    <a href="tel:<?php echo e(__("courses.contacts.info.phone.ua")); ?>"
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="contact4 me-4 mb-3 mt-2">
                                    ...
                                    <a href="tel:<?php echo e(__("courses.contacts.info.phone.le")); ?>"
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="contact3 mt-2">
                                    ...
                                    <a href="tel:<?php echo e(__("courses.contacts.info.phone.be")); ?>" class="color-23 f-600 fs-16 lh-20 me-2">
