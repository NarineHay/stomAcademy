...
} elseif ($_instance->childHasBeenRendered('TlBwz2w')) {
    $componentId = $_instance->getRenderedChildComponentId('TlBwz2w');
    $componentTag = $_instance->getRenderedChildComponentTagName('TlBwz2w');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TlBwz2w');
} else {
    $response = \Livewire\Livewire::mount('front.personal-conferences', []);
    $html = $response->html();
    $_instance->logRenderedChild('TlBwz2w', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
