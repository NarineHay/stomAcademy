...
} elseif ($_instance->childHasBeenRendered('6Ffv12h')) {
    $componentId = $_instance->getRenderedChildComponentId('6Ffv12h');
    $componentTag = $_instance->getRenderedChildComponentTagName('6Ffv12h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6Ffv12h');
} else {
    $response = \Livewire\Livewire::mount('front.change-info', []);
    $html = $response->html();
    $_instance->logRenderedChild('6Ffv12h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
