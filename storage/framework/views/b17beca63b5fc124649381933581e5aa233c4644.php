...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            <form action="<?php echo e(route('admin.webinar.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="user_id" class="form-control select2">
                            <?php $__currentLoopData = $lectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($lector->user->role == 'lector'): ?>
                                    <option value="<?php echo e($lector->id); ?>">
                                        <?php echo e($lector->user->userinfo->fname); ?> <?php echo e($lector->user->userinfo->lname); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" value="<?php echo e(old('start_date') ?? ""); ?>" name="start_date" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">КОЛИЧЕСТВО МИНУТ*</label>
                        <input type="number" value="<?php echo e(old('duration') ?? ""); ?>" name="duration" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e(old('url_to_page') ?? ""); ?>" name="url_to_page" class="form-control">
                    </div>
                                ...
                                <?php $__currentLoopData = \App\Models\Language::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $lg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($k == 0): ?> show active <?php endif; ?>" id="lg_tab_<?php echo e($lg->id); ?>" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title[<?php echo e($lg->id); ?>]" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <textarea class="summernote" name="description[<?php echo e($lg->id); ?>]"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <textarea class="summernote" name="program[<?php echo e($lg->id); ?>]"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="video_invitation[<?php echo e($lg->id); ?>]" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">ВИДЕО</label>
                                            <input type="text" name="video[<?php echo e($lg->id); ?>]" class="form-control">
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views\admin\webinars\create.blade.php ENDPATH**/ ?>