...
} elseif ($_instance->childHasBeenRendered('d1gVmx6')) {
    $componentId = $_instance->getRenderedChildComponentId('d1gVmx6');
    $componentTag = $_instance->getRenderedChildComponentTagName('d1gVmx6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('d1gVmx6');
} else {
    $response = \Livewire\Livewire::mount('front.reg-online-course-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('d1gVmx6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
