...
} elseif ($_instance->childHasBeenRendered('z04LJj9')) {
    $componentId = $_instance->getRenderedChildComponentId('z04LJj9');
    $componentTag = $_instance->getRenderedChildComponentTagName('z04LJj9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('z04LJj9');
} else {
    $response = \Livewire\Livewire::mount('admin.coordinates', ['certificate' => $certificate]);
    $html = $response->html();
    $_instance->logRenderedChild('z04LJj9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
