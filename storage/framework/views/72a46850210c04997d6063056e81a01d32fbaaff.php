...
} elseif ($_instance->childHasBeenRendered('kgiQnf3')) {
    $componentId = $_instance->getRenderedChildComponentId('kgiQnf3');
    $componentTag = $_instance->getRenderedChildComponentTagName('kgiQnf3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kgiQnf3');
} else {
    $response = \Livewire\Livewire::mount('front.support', []);
    $html = $response->html();
    $_instance->logRenderedChild('kgiQnf3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
