...
} elseif ($_instance->childHasBeenRendered('2UK4N47')) {
    $componentId = $_instance->getRenderedChildComponentId('2UK4N47');
    $componentTag = $_instance->getRenderedChildComponentTagName('2UK4N47');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2UK4N47');
} else {
    $response = \Livewire\Livewire::mount('front.personal-courses', []);
    $html = $response->html();
    $_instance->logRenderedChild('2UK4N47', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
