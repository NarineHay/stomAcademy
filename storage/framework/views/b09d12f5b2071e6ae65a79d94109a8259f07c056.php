<div class="bg-white d-flex justify-content-center flex-column align-items-center br-12 p-4">
    <p class="fs-20 f-600 text-center text-dark m-0"><?php echo e(__("header.form.register")); ?></p>
    ...
    <div class="form-group mt-3 mb-2">
        <div class="d-flex justify-content-between align-items-center">
            <label for="exampleInputPassword2"
                   class="mb-1 text-secondary f-500 fs-12 m-0"><?php echo e(__("header.form.password_re")); ?></label>
    ...
    <button type="submit" wire:click="register" class="btn btn-primary mt-3 w-100 fs-14 f-600 py-2 br-12"><?php echo e(__("header.form.register")); ?></button>
    <div class="mt-4 text-center">
        <span class="text-secondary me-1 fs-14 f-500 m-0"><?php echo e(__("header.form.any_time")); ?></span>
        <a wire:click="changeType" class="text-primary fs-14 f-500 m-0"><?php echo e(__("header.form.login")); ?></a>
    </div>

</div>
<?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views/livewire/front/home-register.blade.php ENDPATH**/ ?>