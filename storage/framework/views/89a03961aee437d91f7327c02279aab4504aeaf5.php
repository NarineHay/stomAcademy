...
<?php endif; ?>
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('front.personal-conferences', [])->html();
} elseif ($_instance->childHasBeenRendered('QmnNwlR')) {
    $componentId = $_instance->getRenderedChildComponentId('QmnNwlR');
    $componentTag = $_instance->getRenderedChildComponentTagName('QmnNwlR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QmnNwlR');
} else {
    $response = \Livewire\Livewire::mount('front.personal-conferences', []);
    $html = $response->html();
    $_instance->logRenderedChild('QmnNwlR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views/front/personal/conferences.blade.php ENDPATH**/ ?>