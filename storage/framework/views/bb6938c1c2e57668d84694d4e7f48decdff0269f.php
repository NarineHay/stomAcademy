    ...
    <div class="col-lg-10 col-12 mb-4 mb-lg-6">
        ...
        <div class="d-flex justify-content-between flex-column flex-lg-row mt-4 align-items-lg-center">
            <div class="d-flex education_tags mb-3 mb-lg-0 ">
                ...
                <a href="<?php echo e(route('conference')); ?>" class="px-2 px-md-3 py-2 fs-14 active bg-white f-600 br-12 bg-light-gray text-black btn_text ms-2">
                    Онлайн-конференции
                </a>
            </div>
        ...
        <div class="row mt-4">
            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route("conference.show",$course->id)); ?>" style="color: inherit" class="col-xxl-3 col-lg-4 col-sm-6 col-12 mb-3 md-sm-0">
                    <div class="bg-white br-12">
                        <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($course->image)); ?>" class="w-100" alt="addPic" style="width: 250px; height: 150px; object-fit: cover">
                        <div class="p-3">
                            ...
                            <div class="d-flex flex-column flex-xl-row mt-4 justify-content-between align-items-xl-center" style="min-height: 63px;">
                                <div class="d-flex align-items-center me-2">
                                    <div class="d-flex align-items-center">
                                        <?php $__currentLoopData = $course->getLectors()->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $lector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($lector->userInfo->image)); ?>" style="width: 48px;height: 48px;object-fit: cover" class="<?php if($k>0): ?> m-25 <?php endif; ?> rounded-circle border" alt="personPic">
                                ...
                                <div class="mt-3 mt-xl-0 d-flex flex-row flex-xl-column">
                                    <?php if($course->sale): ?>
                                        ...
                                        <span class="f-700 del text-secondary fs-16  text-nowrap"><?php echo e($course->price->html()); ?></span>
                                    <?php else: ?>
                        ...
                        <div class="mt-2">
                            <ul class="list-unstyled m-0 p-0">
                                <?php $__currentLoopData = $directions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <input wire:model="selectedDirections" type="checkbox" id="dir-<?php echo e($direction->id); ?>"
                                               value="<?php echo e($direction->id); ?>" class="mt-2">
...
<?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views\livewire\front\online-courses-catalog.blade.php ENDPATH**/ ?>