<div class="d-flex header_menu">
    ...
    <nav class="navbar p-0">
        ...
        <ul class="text-decoration-none list-unstyled d-flex mb-0">
            <li><a href="<?php echo e(route("course.index")); ?>"
                   class="text-decoration-none me-2 me-xl-3 text-white fs-16 f-600"><?php echo e(__("header.menu.courses")); ?></a>
            </li>
            <li><a href="<?php echo e(route("lectors.index")); ?>"
                   class="text-decoration-none ms-3 me-2 me-xl-3 ms-xl-4 text-white fs-16 f-600"><?php echo e(__("header.menu.lectors")); ?></a>
            </li>
            <li><a href="<?php echo e(route("about")); ?>"
                   class="text-decoration-none ms-3 me-2 me-xl-3 ms-xl-4 text-white fs-16 f-600"><?php echo e(__("header.menu.about")); ?></a>
            </li>
            <li><a href="<?php echo e(route("blog.index")); ?>"
                   class="text-decoration-none ms-3 me-2 me-xl-3 ms-xl-4 text-white fs-16 f-600"><?php echo e(__("header.menu.blog")); ?></a>
            </li>
            <li><a href="<?php echo e(route("contacts")); ?>"
                   class="text-decoration-none ms-3 me-2 me-xl-3 ms-xl-4 text-white fs-16 f-600"><?php echo e(__("header.menu.contact")); ?></a>
            </li>
            <li>
                <div class="dropdown">
                    <a class="text-decoration-none ms-3 me-2 me-xl-3 ms-xl-4 text-white fs-16 f-600 text-uppercase dropdown-toggle"
                       data-bs-toggle="dropdown">
                        <?php echo e(\App\Models\Currency::find(\Illuminate\Support\Facades\Cookie::get("currency_id"))->currency_name); ?>

                        <i class="icon-<?php echo e(\Illuminate\Support\Str::lower(\App\Models\Currency::find(\Illuminate\Support\Facades\Cookie::get("currency_id"))->currency_name)); ?>"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end cur-dropdown" aria-labelledby="dropdownMenuLink">
                        <?php $__currentLoopData = \App\Models\Currency::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a class="dropdown-item"
                                   href="<?php echo e(route("change_cur",$cur->id)); ?>"><?php echo e($cur->currency_name); ?> <i
                                        class="icon-<?php echo e(\Illuminate\Support\Str::lower($cur->currency_name)); ?>"></i></a>
                            </li>
            ...
            <li>
                <div class="dropdown header_flag">
                    <a class="text-decoration-none ms-3 me-2 me-xl-3 ms-xl-4 text-white fs-16 f-600 text-uppercase dropdown-toggle"
                       data-bs-toggle="dropdown">
                        <img
                            src="/dist/image/<?php echo e(\Illuminate\Support\Str::lower(\Illuminate\Support\Facades\App::getLocale())); ?>.svg">
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                        <?php $__currentLoopData = \App\Models\Language::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a class="dropdown-item" href="<?php echo e(route("change_lg",$lg->id)); ?>"><img class="me-2"
                                                                                                      src="/dist/image/<?php echo e(\Illuminate\Support\Str::lower($lg->code)); ?>.svg"><?php echo e($lg->name); ?>
...
<?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views\front\components\header_menu.blade.php ENDPATH**/ ?>