<?php if(auth()->guard()->check()): ?>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex mb-0 align-items-center ">
            ...
            <?php endif; ?>
            <a href="<?php echo e($href); ?>" class="d-flex align-items-center mb-0 user-svg user-svg-1">
                <?php if($user->userInfo->image): ?>
                    <img class="rounded-circle mx-lg-2" style="height: 30px;width: 30px"
                         src="<?php echo e(\Illuminate\Support\Facades\Storage::url($user->userInfo->image)); ?>">
                <?php else: ?>


                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.1714 14.6421C18.885 13.8616 19.2823 12.8433 19.2857 11.7857C19.2857 9.42214 17.3636 7.5 15 7.5C12.6364 7.5 10.7143 9.42214 10.7143 11.7857C10.7177 12.8433 11.115 13.8616 11.8286 14.6421C9.27643 15.84 7.5 18.4275 7.5 21.4286C7.5 21.7127 7.61288 21.9853 7.81381 22.1862C8.01475 22.3871 8.28727 22.5 8.57143 22.5H21.4286C21.7127 22.5 21.9853 22.3871 22.1862 22.1862C22.3871 21.9853 22.5 21.7127 22.5 21.4286C22.5 18.4275 20.7236 15.84 18.1714 14.6421ZM12.8571 11.7857C12.8571 10.6039 13.8182 9.64286 15 9.64286C16.1818 9.64286 17.1429 10.6039 17.1429 11.7857C17.1429 12.9675 16.1818 13.9286 15 13.9286C13.8182 13.9286 12.8571 12.9675 12.8571 11.7857ZM9.75107 20.3571C10.2482 17.9154 12.4136 16.0714 15 16.0714C17.5864 16.0714 19.7518 17.9154 20.2489 20.3571H9.75107Z" fill="white"/>
                        <path d="M15 0C6.72857 0 0 6.72857 0 15C0 23.2714 6.72857 30 15 30C23.2714 30 30 23.2714 30 15C30 6.72857 23.2714 0 15 0ZM15 27.8571C7.91036 27.8571 2.14286 22.0896 2.14286 15C2.14286 7.91036 7.91036 2.14286 15 2.14286C22.0896 2.14286 27.8571 7.91036 27.8571 15C27.8571 22.0896 22.0896 27.8571 15 27.8571Z" fill="white"/>
                    </svg>
                <?php endif; ?>
            </a>
                ...
                <div class="offcanvas-body">
                    <div>
                        <div class="mb-6 my-4 my-lg-6" style="z-index: 1">
                            <img
                                src="<?php echo e(\Illuminate\Support\Facades\Storage::url($user->userinfo->image ?? "userinfo/unknown.png")); ?>"
                   ...
                   <?php echo e($user->userinfo->lname); ?>
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <p class="m-0 fs-14 f-500 text-secondary ms-2">
                                    <a href="<?php echo e(route('personal.information')); ?>" style="color: #7A7A7A">Настройки
                                        профиля</a>
                                </p>
                            </div>
                        </div>
                        <div>
                            <div class="d-flex mb-4 mt-4 " style="gap:7px;">
                                ...
                                <a href="<?php echo e(route('personal.courses')); ?>"
            ...
            <div class="text-white d-block noticeCount">
                <p class="fs-12 f-700 d-flex rounded-circle justify-content-center"><?php echo e($count ?? '0'); ?></p>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\OpenServer\domains\StomAcademy\resources\views\components\header-user.blade.php ENDPATH**/ ?>